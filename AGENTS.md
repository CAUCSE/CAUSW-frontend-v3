...
- branch 접두사와 pull request 제목 라벨은 같은 작업 유형을 가리켜야 한다.

| 작업 유형 | GitHub label | branch 접두사 | issue/PR 제목 라벨 |
| --- | --- | --- | --- |
...
- 작업 라벨은 공통 작업 라벨 표의 `issue/PR 제목 라벨`을 따른다.
...
- 작업 라벨은 공통 작업 라벨 표를 따르며, 브랜치 접두사와 일치하는 유형을 사용한다.
