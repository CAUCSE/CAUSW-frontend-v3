  ...
  return (
    <button
      ...
      className={mergeStyles(
        'h-12 w-full cursor-pointer rounded-[10px] bg-[#FEE500] py-3.5 transition-all duration-200 hover:enabled:opacity-80 active:enabled:opacity-80 disabled:cursor-not-allowed disabled:opacity-50',
        className,
      )}
    >
