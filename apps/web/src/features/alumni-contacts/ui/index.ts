...
export { AlumniContactsDepartmentFilterButton } from './alumni-contacts-department-filter-button';
...
export { AlumniContactsDepartmentFilterChip } from './alumni-contacts-department-filter-chip';
