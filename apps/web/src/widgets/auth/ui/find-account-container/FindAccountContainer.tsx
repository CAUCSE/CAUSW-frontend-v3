      ...
      <VStack className="w-full gap-6">
        ...
        >
          <Tab.List className="gap-0 rounded-[0.75rem] bg-white p-1">
            <Tab.TabItem
              value="find-email"
              className="flex-1 justify-center rounded-[0.5rem] bg-transparent py-2 aria-selected:bg-gray-100"
            >
              <Text
          ...
          <Tab.Content value="find-password">
            <VStack className="w-full gap-10" />
          </Tab.Content>
        </Tab>
      </VStack>
