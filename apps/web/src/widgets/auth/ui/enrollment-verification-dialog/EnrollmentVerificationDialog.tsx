...
export const EnrollmentVerificationDialog = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <Dialog.Content className="flex h-full max-h-[100dvh] w-full flex-col overflow-hidden rounded-none bg-gray-100 px-0 py-0 pb-(--safe-area-inset-bottom) md:h-auto md:max-h-[min(50rem,calc(100dvh-2rem))] md:w-full md:max-w-[43.75rem] md:rounded-lg md:px-4 md:py-6">
