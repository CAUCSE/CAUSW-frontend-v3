...
export function TermsOfServicePage() {
  return (
    <div className="z-modal fixed inset-0 bg-white md:flex md:items-center md:justify-center md:bg-black/50 md:p-6">
      <div className="h-full overflow-y-auto bg-white md:h-auto md:max-h-[90vh] md:w-full md:max-w-175 md:rounded-2xl md:bg-gray-100 md:p-8">
