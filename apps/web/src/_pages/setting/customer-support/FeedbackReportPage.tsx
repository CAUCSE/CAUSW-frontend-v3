...
export function FeedbackReportPage() {
  ...
  return (
    <div className="z-modal fixed inset-0 bg-gray-100 md:flex md:items-center md:justify-center md:bg-black/50 md:p-6">
      <div className="h-full overflow-y-auto bg-gray-100 md:h-auto md:max-h-[90vh] md:w-full md:max-w-175 md:rounded-2xl md:p-8">
        ...
        <div className="px-5 pb-8 md:px-0 md:pb-0">
          ...
          <div className="space-y-8">
                ...
                <div className="flex gap-2">
                  {[1, 2, 3, 4, 5].map((value) => (
                    <button
                      ...
                      className={`typo-body-16-regular h-16.75 flex-1 rounded-lg ${
                        score === value
                ...
                {photos.length > 0 && (
                  <div className="mb-4 flex gap-2 overflow-x-auto">
                    {photos.map((photoId) => (
                      <div
                        key={photoId}
                        className="relative h-25 w-25 shrink-0 rounded-lg bg-gray-200"
                      >
                        <button
                          type="button"
            ...
            <button
              type="button"
              className={`typo-body-15-semibold h-13.5 w-full rounded-xl ${
                canSubmit
                  ? 'bg-gray-700 text-white'
